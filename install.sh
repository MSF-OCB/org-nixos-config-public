...
mkdir --parents "${extra_files}/var/lib/msf-ocb/"
ssh-keygen -t ed25519 -C "" -N "" -f "${extra_files}/var/lib/msf-ocb/id_tunnel"
...
rm -rf "${extra_files}/var/lib/msf-ocb/id_tunnel"
...
jq \
  ...
  --arg pubkey "$(sed -e 's: *$::' "${extra_files}/var/lib/msf-ocb/id_tunnel.pub")" \
...
cat "${extra_files}/var/lib/msf-ocb/id_tunnel.pub"
echo
