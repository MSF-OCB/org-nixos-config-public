...
let
  ...
  org_metadata = lib.importJSON ../demo-org-config/json/org-metadata.json;
in
  ...
  config = {
    settings = {
      system = {
        ...
        users_json_path = ../demo-org-config/json/users.json;
        tunnels_json_dir_path = ../demo-org-config/json/tunnels.d;
        keys_json_path = ../demo-org-config/json/keys.json;
        secrets = {
          dest_directory = "/run/.secrets/";
          old_dest_directories = [ "/opt/.secrets" ];
          src_directory = ../demo-org-config/secrets/generated;
        };
        app_configs = {
          dest_directory = "/run/.app_configs/";
          src_directory = ../demo-org-config/app_configs/generated;
        };
      };
      ...
      maintenance.config_repo = {
        ...
        branch =
          let
            waves_and_staging_hosts = lib.importJSON ../demo-org-config/json/waves-and-staging-hosts.json;
      ...
      reverse_tunnel =
        let
          relay_jsondata = lib.importJSON ../demo-org-config/json/relay-servers.json;
