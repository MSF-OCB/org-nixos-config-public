{ lib, modulesPath, config, options, ... }:
    ...
    boot =
      let
        platformDependent = {
          ...
          nuc = {
            initrd.availableKernelModules = [ "ahci" "nvme" "sd_mod" "sdhci_pci" "xhci_pci" ];
          };
          laptop = {
            initrd.availableKernelModules = [ "ahci" "ehci_pci" "nvme" "rtsx_pci_sdmmc" "sd_mod" "sr_mod" "usb_storage" "xhci_pci" ];
          };
          synology = {
          ...
          thinkserver = {
            initrd.availableKernelModules = [ "ahci" "megaraid_sas" "sd_mod" "xhci_pci" ];
          };
          virtualbox = {
            # https://github.com/NixOS/nixpkgs/issues/76980
            initrd.availableKernelModules = [ "ahci" "ohci_pci" "sd_mod" "sr_mod" "virtio_pci" "virtio_scsi" "xhci_pci" ];
          };
          vmware = {
            initrd.availableKernelModules = [ "ahci" "ata_piix" "floppy" "mptspi" "sd_mod" "sr_mod" "vmw_pvscsi" ];
          };
          hetzner = {
